...
#'
#' @description Quantile normalization of a data matrix where rank
...
#' @param index an integer or a vector integers specifying the indices of
#' selected rows.
#' @details Selected rows and/or rows with rank invariance frequency
