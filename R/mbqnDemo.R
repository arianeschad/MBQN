...
#' mbqnDemo(x)
#' @details Normalize matrix and return boxplots of quantile normalized and
#' mean balanced normalized data.
...
mbqnDemo <- function(x = NULL){
    ...
    # matrix object specifying the location of the next N figures
    mtx <- matrix(c(2, 3, 3, 6,
                    4, 1, 1, 5), byrow=TRUE, nrow=2)
    # layout of plot arrangement
