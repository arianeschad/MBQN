...
To install this package from Bioconductor, type in R (version >="3.3.3"): 
...
## Dependencies
The package depends on the `limma` package for computation of the conventional quantile normalization: <br/>
```{r , eval = FALSE}
BiocManager::install("limma")
```
Alternatively, `normalize.quantiles()` from the package preprocessCore by B. Bolstad (2016),  preprocessCore: A collection of pre-processing functions. R package version 1.36.0. available from https://github.com/bmbolstad/preprocessCore: <br/>
```{r , eval = FALSE}
BiocManager::install("preprocessCore")
```


Collecting data from PRIDE experiments in `mbqnExample()` requires the R package rpx by L. Gatto (2017), version 1.10.2. available from https://github.com/lgatto/rpx or via Bioconductor: <br/>
```{r , eval = FALSE}
...
## Documentation
To view the documentation for MBQN, type the following command in R:
