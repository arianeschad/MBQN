...
The function `getPXDfile()` in MBQN uses data from the PRIDE repository. To run this function one needs the R package `rpx` [4] to download the data. <br/>
...
## References
[1] Brombacher, E., Schad, A., Kreutz, C. (2020). Tail-Robust Quantile Normalization. BioRxiv. <br/>
